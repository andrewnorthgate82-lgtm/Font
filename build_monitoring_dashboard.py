...
def build():
    ...
    notes = [
        ...
        "۲. نکته محاسباتی شاخص ۱: حدانتظار سواد رسانه حضوری (ضریب ۳۱×) حاصل جمع نشست‌های حضوری (شیت سوادرسانه حضوری) و کارگاه‌های توانمندسازی (شیت توانمندسازی گردان) در فایل اکسل ماهانه کارمندان است.",
